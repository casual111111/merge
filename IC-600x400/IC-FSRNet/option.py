...
parser.add_argument("--input_size_x", type=int, default=400)
parser.add_argument("--input_size_y", type=int, default=600)
parser.add_argument('--dir_data', type=str, default='/root/autodl-tmp/dataset/LLLR/LOL/lol_dataset',
                    help='dataset directory')
parser.add_argument('--data_train', type=str, default='our485',
                    help='train dataset name')
parser.add_argument('--data_val', type=str, default='eval15',
...
parser.add_argument("--writer_name", type=str, default="try9.6",
