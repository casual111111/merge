...
parser.add_argument('--dir_data', type=str, default='/root/autodl-tmp/dataset/LLLR/LOL/lol_256',
                    help='dataset directory')
parser.add_argument('--data_train', type=str, default='our480',
                    help='train dataset name')
parser.add_argument('--data_val', type=str, default='val5',
                    help='val dataset name')
parser.add_argument('--data_test', type=str, default='test15',
...
parser.add_argument("--writer_name", type=str, default="try_lol",
